...
import CompareRadarChart from './RadarChart';
...
describe('CompareRadarChart', () => {
    ...
    it('renders PolarGrid component when both characters are provided', () => {
        const { container } = render(<CompareRadarChart character1={character1} character2={character2} />);
    ...
    it('returns null when either character1 or character2 is missing', () => {
        const { container } = render(<CompareRadarChart character1={null} character2={character2} />);
        ...
        const { container: container2 } = render(<CompareRadarChart character1={character1} character2={null} />);
